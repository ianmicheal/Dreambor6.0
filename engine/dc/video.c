 ...
 */
 // Ported to dreamcast version from 6xxxx src By Ian micheal 2019
#include "sdlport.h"
...
SDL_Surface* SetVideoMode(int w, int h, int bpp, bool gl)
{
	...
	return SDL_SetVideoMode(w, h, bpp, savedata.fullscreen?(SDL_SWSURFACE|SDL_DOUBLEBUF|SDL_FULLSCREEN):(SDL_HWSURFACE|SDL_DOUBLEBUF));
